...
import com.smarte2e.unit.supplemental.classes.NestedPojoClass;
import com.smarte2e.unit.supplemental.classes.PojoClass;
...
*/
    ...
    public void testFullClassNameToPackageNameWithValidFullClassName() {
        String fullClassName = "com.smarte2e.SomeClass";
        String packageName = ConvertUtils.fullClassNameToPackageName(fullClassName);
        Assert.assertEquals(packageName, "com.smarte2e");
    }
