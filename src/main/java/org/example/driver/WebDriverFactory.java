...
/*            driver = new RobustWebDriver(getAWSRemoteWebDriver(
    ...
    public static WebDriver getLocalWebDriver() {
        ...
        String chromeDriverPath = String.format("%s/%s", currentDirectory, "chromedriver-linux64/chromedriver");
        String chromeBrowserPath = String.format("%s/%s", currentDirectory, "chrome-linux64/chrome");
