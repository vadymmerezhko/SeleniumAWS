package com.smarte2e.balancers;

import lombok.extern.slf4j.Slf4j;
import com.smarte2e.constants.Settings;
...
import static com.smarte2e.constants.Settings.AWS_EC2_USER_DATA_TEMPLATE;
...
public class LoadBalancer {
    ...
    public synchronized String getServerPublicIp(long serverId, int threadCount, BrowserName browserName, String browserVersion) {
        ...
        if (serverIdPublicIpMap.isEmpty()) {
            try {
                ServerUtils.createSeleniumServerInstances(
