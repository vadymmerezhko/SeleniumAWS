...
public final class ServerUtils {
    ...
    public static void createSeleniumServerInstances(int serverCount,
        ...
        AmazonEC2 ec2 = com.smarte2e.utils.AwsUtils.getEC2Client();

        for (long i = 0; i < serverCount; i++) {
            String instanceId = com.smarte2e.utils.AwsUtils.runEC2AndEWaitForId(
                    ec2, threadCount,  awsImageId, securityKeyPairName, securityGroupName, userData);
            loadBalancer.setServerEC2Id(i, instanceId);
            String instanceIp = com.smarte2e.utils.AwsUtils.waitForEC2Ip(ec2, instanceId);
    ...
    public static synchronized void waitForServerAvailability(String serverIP, int port) {
        ...
        while (true) {
            com.smarte2e.utils.TimerUtils.waitSeconds(1);
    ...
    public static synchronized String createLocalRunServerAndRunTests() {
        try {
            ...
            String accessKey = com.smarte2e.utils.AwsUtils.getAwsAccessKey();
            String secretKey = com.smarte2e.utils.AwsUtils.getAwsSecretKey();
            ...
            AmazonEC2 ec2 = com.smarte2e.utils.AwsUtils.getEC2Client();
            String instanceId = com.smarte2e.utils.AwsUtils.runEC2AndEWaitForId(ec2, config.getThreadCount(),
                    AWS_LOCAL_RUN_IMAGE_ID, SECURITY_KEY_PAIR_NAME, SECURITY_GROUP_NAME, encodedUserData);
            String publicIp = com.smarte2e.utils.AwsUtils.waitForEC2Ip(ec2, instanceId);
            ...
            com.smarte2e.utils.AwsUtils.terminateEC2(ec2, instanceId);
            ...
            String logFilePath = com.smarte2e.utils.AwsUtils.downloadFileFromS3(testLogFileName, ".",
                    TEST_REPORTS_AWS_BUCKET_NAME, accessKey, secretKey);
            String testOutput = com.smarte2e.utils.FileSystemUtils.readFile(logFilePath);
            com.smarte2e.utils.FileSystemUtils.deleteFile(logFilePath);
            return testOutput;
        }
        catch (Exception e) {
