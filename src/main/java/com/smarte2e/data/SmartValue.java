 ...
 */
@Slf4j
public class SmartValue extends com.smarte2e.data.SmartObject implements com.smarte2e.data.FormattedValue {
    ...
    private com.smarte2e.data.SmartType smartType;
    ...
    private com.smarte2e.data.SmartObject parent;
    private String name;
     ...
     */
    SmartValue(com.smarte2e.data.SmartType smartType, String valueTemplate) {
     ...
     */
    SmartValue(com.smarte2e.data.SmartType smartType, String valueTemplate, String format) {
    ...
    public void setValue(Object value) {
        ...
        smartType = com.smarte2e.data.SmartType.fromObject(value);
        valueSet = true;
     ...
     * @return The type.
     */
    public com.smarte2e.data.SmartType getSmartType() {
        setUp();
    ...
    public char toCharacter() {
        setUp();
        char result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Character.class), value);
        log.debug("""
    ...
    public short toShort() {
        setUp();
        short result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Short.class), value);
        log.debug("""
    ...
    public int toInteger() {
        setUp();
        int result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Integer.class), value);
        log.debug("""
    ...
    public long toLong() {
        setUp();
        long result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Long.class), value);
        log.debug("""
    ...
    public BigInteger toBigInteger() {
        setUp();
        BigInteger result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(BigInteger.class), value);
        log.debug("""
    ...
    public float toFloat() {
        setUp();
        float result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Float.class), value);
        log.debug("""
    ...
    public double toDouble() {
        setUp();
        double result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Double.class), value);
        log.debug("""
    ...
    public BigDecimal toBigDecimal() {
        setUp();
        BigDecimal result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(BigDecimal.class), value);
        log.debug("""
    ...
    public boolean toBoolean() {
        setUp();
        boolean result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Boolean.class), value);
        log.debug("""
    ...
    public Date toDate() {
        setUp();
        Date result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Date.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartDate toSmartDate() {
        setUp();
        com.smarte2e.data.SmartDate result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartDate.class), value);
        log.debug("""
    ...
    public LocalDate toLocalDate() {
        setUp();
        LocalDate result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(LocalDate.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartLocalDate toSmartLocalDate() {
        setUp();
        com.smarte2e.data.SmartLocalDate result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartLocalDate.class), value);
        log.debug("""
    ...
    public LocalDateTime toLocalDateTime() {
        setUp();
        LocalDateTime result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(LocalDateTime.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartLocalDateTime toSmartLocalDateTime() {
        setUp();
        com.smarte2e.data.SmartLocalDateTime result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartLocalDateTime.class), value);
        log.debug("""
    ...
    public LocalTime toLocalTime() {
        setUp();
        LocalTime result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(LocalTime.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartLocalTime toSmartLocalTime() {
        setUp();
        com.smarte2e.data.SmartLocalTime result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartLocalTime.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartNumber toSmartNumber() {
        setUp();
        com.smarte2e.data.SmartNumber result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartNumber.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartCurrency toSmartCurrency() {
        setUp();
        com.smarte2e.data.SmartCurrency result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartCurrency.class), value);
        log.debug("""
     ...
     */
    public com.smarte2e.data.SmartTelephoneNumber toSmartPhoneNumber() {
        setUp();
        com.smarte2e.data.SmartTelephoneNumber result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(com.smarte2e.data.SmartTelephoneNumber.class), value);
        log.debug("""
    ...
    public Color toColor() {
        setUp();
        Color result = ConvertUtils.objectToObject(com.smarte2e.data.SmartType.fromClass(Color.class), value);
        log.debug("""
     ...
     */
    public <T extends Enum<T>> T toEnumValue(com.smarte2e.data.SmartType enumType) {
        setUp();
     ...
     */
    public <T> T toPojoObject(com.smarte2e.data.SmartType targetType) {
    ...
    private void setUpValue() {
        ...
        if (format == null && value != null) {
            ...
            if (value instanceof com.smarte2e.data.FormattedValue formattedValue) {
    ...
    void setParent(com.smarte2e.data.SmartObject parent) {
        this.parent = parent;
    }
    ...
    void setUpValueFromFile() {
        ...
        try {
            if (valuesMap.containsKey(name)) {
                ...
                com.smarte2e.data.SmartType validValueType;
    ...
    private void saveValueToFile() {
        ...
        com.smarte2e.data.SmartType type = getSmartType();
        ...
        try {
            com.smarte2e.data.SmartType smartType = getSmartType();
    ...
    private static JSONObject getJsonFromSmartType(com.smarte2e.data.SmartType smartType) {

        try {
            Class<?> objectClass = smartType.getObjectClass();
            Class<?> keyClass = smartType.getKeyClass();
            com.smarte2e.data.SmartType valueSmartType = smartType.getValueSmartType();
            ...
            if (valueSmartType != null) {
                ...
                Map<String, com.smarte2e.data.SmartType> fieldTypesMap = smartType.getFieldTypesMap();
    ...
    private static JSONObject getJsonFromFieldTypesMap(Map<String, com.smarte2e.data.SmartType> fieldTypesMap) {

        try {
            JSONObject fieldTypesJson = new JSONObject();

            for (String fieldName : fieldTypesMap.keySet()) {
                com.smarte2e.data.SmartType fileldSmartType = fieldTypesMap.get(fieldName);
    ...
    private static com.smarte2e.data.SmartType getSmartTypeFromJson(JSONObject typeJson) {
        com.smarte2e.data.SmartType smartType;

        try {
            Class<?> objectClass = Class.forName((typeJson.getString(OBJECT_CLASS)));

            if (typeJson.has(VALUE_TYPE)) {
                com.smarte2e.data.SmartType valueSmartType = getSmartTypeFromJson(typeJson.getJSONObject(VALUE_TYPE));

                if (typeJson.has(KEY_CLASS)) {
                    Class<?> keyClass = Class.forName(typeJson.getString(KEY_CLASS));
                    smartType = com.smarte2e.data.SmartType.fromMapClass(objectClass, keyClass, valueSmartType);
                } else {
                    smartType = com.smarte2e.data.SmartType.fromCollectionClass(objectClass, valueSmartType);
                }
            } else if (typeJson.has(FIELD_TYPES)) {
                JSONObject fieldTypesJson = typeJson.getJSONObject(FIELD_TYPES);
                com.smarte2e.data.SmartType fieldsTypesMapType = getSmartTypeFromJson(fieldTypesJson);
                Map<String, com.smarte2e.data.SmartType> fieldTypesMap =
                        ConvertUtils.jsonObjectToMap(fieldsTypesMapType, fieldTypesJson);
                smartType = com.smarte2e.data.SmartType.fromPojoClass(objectClass, fieldTypesMap);
            } else {
                smartType = com.smarte2e.data.SmartType.fromClass(objectClass);
            }
            log.debug("""
    ...
    private static SmartValue getSmartValueFromJson(com.smarte2e.data.SmartType smartType, JSONObject valueJson) {
    ...
    private static void readValueFromFile(String fileName, Map<String, SmartValue> valuesMap) {
        ...
        if (!fileContent.trim().isEmpty()) {
            ...
            for (String fieldName : json.keySet()) {
                ...
                com.smarte2e.data.SmartType smartType = getSmartTypeFromJson(typeJson);
